    ...
    <>
        ...
        <div className='text-xs text-center px-24 text-white bg-zinc-900'>
                ...
                <p>
                    ...
                    <br />
                    We do not ship to the following areas where KRATOM is banned:
                    <br />
                    <span className='font-bold'>
                    ALABAMA, ARKANSAS, INDIANA, RHODE ISLAND, VERMONT, WISCONSIN. SARASOTA COUNTY, UNION COUNTY, 
                    MALHEUR COUNTY, DENVER CO, SAN DIEGO CA, CITY OF OCEANSIDE,CA, JERSEYVILLE IL, ALTON IL, AND 
                    COLUMBUS MS.
                    </span>
                    <br />
                    In addition, KRATOM is also banned in the following countries where the shipment of KRATOM is not permitted:
                    <br />
                    <span className='font-bold'> 
                    AUSTRALIA, BURMA, DENMARK, FINLAND, ISRAEL, LITHUANIA, MALAYSIA, MYANMAR, POLAND, ROMANIA, SOUTH KOREA, SWEDEN, 
                    THAILAND, UNITED KINGDOM, and VIETNAM
                    </span>
                </p>
                <br />
                <p>Kratom.org Verified Vendor</p>
                <br />
            </div>
        <div class="bg-black">
            ...
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
                ...
                <span class="ml-3 text-xl">FastIncense</span>
            </a>
            <p class="text-sm text-white sm:ml-6 sm:mt-0 mt-4">© 2020 FastIncense —
                <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-white ml-1" target="_blank">@iamDaleon</a>
            </p>
