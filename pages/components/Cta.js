...
const Cta = () => {
  return (
    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        ...
        <h1 class="title-font font-medium text-3xl font-bold text-white">RECEIVE SPECIAL OFFERS VIA EMAIL!</h1>
        <p class="leading-relaxed text-gray-400 mt-4">Just for signing up today, you'd receive free shipping on your next order coupon.</p>
        </div>
        ...
        <button class="text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Sign me up</button>
        </div>
    </div>
    </section>
    </>
